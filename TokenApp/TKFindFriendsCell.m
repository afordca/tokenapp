...
#import "TKFindFriendsCell.h"
#import "TKProfileImageView.h"
#import "Constants.h"
#import "TKUtility.h"

@interface TKFindFriendsCell ()
...
@implementation TKFindFriendsCell
@synthesize delegate;
@synthesize user;
...
- (void)setUser:(PFUser *)aUser {
    ...
    // Set name
    NSString *nameString = [self.user objectForKey:kTKUserDisplayNameKey];
    CGSize nameSize = [nameString boundingRectWithSize:CGSizeMake(144.0f, CGFLOAT_MAX)
                                            ...
                                            attributes:@{NSFontAttributeName:[UIFont boldSystemFontOfSize:16.0f]}
                                               context:nil].size;
    [nameButton setTitle:[self.user objectForKey:kTKUserDisplayNameKey] forState:UIControlStateNormal];
    [nameButton setTitle:[self.user objectForKey:kTKUserDisplayNameKey] forState:UIControlStateHighlighted];
