...
-(id)initWithUsername:(NSString*)name profilePic:(UIImage*)profilepic timePosted:(NSString*)time photo:(Photo*)photo post:(Post*)message video:(Video*)video link:(Link*)link mediaType:(NSString*)mediatype userID:(NSString*)userID user:(User*)user;
