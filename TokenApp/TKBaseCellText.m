...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        horizontalTextSpace =  [TKBaseCellText horizontalTextSpaceForInsetWidth:cellInsetWidth];
        ...
        self.avatarImageView = [[TKProfileImageView alloc] init];
...
#pragma mark - TKBaseTextCell

/* Static helper to get the height for a cell if it had the given name and content */
+ (CGFloat)heightForCellWithName:(NSString *)name contentString:(NSString *)content {
    return [TKBaseCellText heightForCellWithName:name contentString:content cellInsetWidth:0];
}
...
+ (CGFloat)heightForCellWithName:(NSString *)name contentString:(NSString *)content cellInsetWidth:(CGFloat)cellInset {
    ...
    NSString *paddedString = [TKBaseCellText padString:content withFont:[UIFont systemFontOfSize:13] toWidth:nameSize.width];
    CGFloat horizontalTextSpace = [TKBaseCellText horizontalTextSpaceForInsetWidth:cellInset];
...
- (void)setUser:(PFUser *)aUser {
    ...
    [self.nameButton setTitle:[self.user objectForKey:kTKUserDisplayNameKey] forState:UIControlStateNormal];
    [self.nameButton setTitle:[self.user objectForKey:kTKUserDisplayNameKey] forState:UIControlStateHighlighted];
...
- (void)setContentText:(NSString *)contentString {
    ...
    if (self.user) {
        CGSize nameSize = [self.nameButton.titleLabel.text boundingRectWithSize:CGSizeMake(nameMaxWidth, CGFLOAT_MAX)
                                                                     ...
                                                                     attributes:@{NSFontAttributeName:[UIFont boldSystemFontOfSize:13.0f]}
                                                                        context:nil].size;
        NSString *paddedString = [TKBaseCellText padString:contentString withFont:[UIFont systemFontOfSize:13] toWidth:nameSize.width];
...
- (void)setCellInsetWidth:(CGFloat)insetWidth {
    ...
    horizontalTextSpace = [TKBaseCellText horizontalTextSpaceForInsetWidth:insetWidth];
    [self setNeedsDisplay];
}
...
- (id<TKBaseCellTextDelegate>)delegate {
    return (id<TKBaseCellTextDelegate>)delegate;
}

- (void)setDelegate:(id<TKBaseCellTextDelegate>)aDelegate {
